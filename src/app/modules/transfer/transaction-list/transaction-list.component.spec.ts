...
describe('TransactionListComponent', () => {
  ...
  const subjectMock = new BehaviorSubject<any>(modelStub.data);
  const transferService: any = jasmine.createSpyObj('TransferService', [
    'getTransactions',
  ]);
  transferService.getTransactions.and.returnValue(of(modelStub.data));
  transferService.transactions$ = subjectMock.asObservable();
  transferService.updateTransactions = function (data: any) {
    console.log('update transactions' + data);
  };
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [
        ...
        // { provide: TransactionFilterPipe, useValue: TransactionFilterPipe },
      ],
    }).compileComponents();
  });
  ...
  it('should call the getTransactions', () => {
    expect(transferService.getTransactions).toHaveBeenCalled();
  });
});
